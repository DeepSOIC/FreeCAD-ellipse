...
class ConstraintTangentCircleLine;
typedef Base::UnsafePyHandle<ConstraintTangentCircleLine> HConstraintTangentCircleLine;

class FCSExport ConstraintTangentCircleLine : public FCS::SimpleConstraint
{
...
public: //friends
    friend class ConstraintTangentCircleLinePy;
};
