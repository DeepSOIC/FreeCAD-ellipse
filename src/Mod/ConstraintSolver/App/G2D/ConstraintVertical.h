...
class ConstraintVertical;
typedef Base::UnsafePyHandle<ConstraintVertical> HConstraintVertical;

class FCSExport ConstraintVertical : public FCS::SimpleConstraint
{
...
public: //friends
    friend class ConstraintVerticalPy;
};
