...
#ifndef FREECAD_CONSTRAINTSOLVER_G2D_PARABSPLINEBASE_H
#define FREECAD_CONSTRAINTSOLVER_G2D_PARABSPLINEBASE_H
...
class ParaBSplineBase;
typedef Base::UnsafePyHandle<ParaBSplineBase> HParaBSplineBase;
typedef Base::UnsafePyHandle<ParaShape<ParaBSplineBase>> HShape_BSplineBase;

class FCSExport ParaBSplineBase : public FCS::G2D::ParaCurve
{
...
public://methods
    ParaBSplineBase();
    ParaBSplineBase(HParaPoint p1, HParaPoint p2);
...
public: //friends
    friend class ParaBSplineBasePy;
